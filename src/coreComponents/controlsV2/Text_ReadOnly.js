  ...
  return (
    <div>
       <label className="active" htmlFor={component.ComponentId} style={{margin:'8px'}}>{component.ComponentLabel}</label>
        <input disabled  type="text" id={component.ComponentId} className="validate"style={{color:'black'}} defaultValue={component.DefaultValue}
